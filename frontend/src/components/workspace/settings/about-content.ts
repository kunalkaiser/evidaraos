/**
 * About content for the EvidaraOS workspace. Runtime attribution is preserved
 * here and in the public third-party notices page.
 */
export const aboutMarkdown = `# About EvidaraOS
