...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to the EvidaraOS workspace. Start from an evidence module, or open a chat when you need a custom workflow.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create an EvidenceOS workflow skill for a specific review, modeling, regulatory, payer, or discovery process.",
  },
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. EvidaraOS is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but EvidaraOS could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "EvidaraOS website",
    githubTooltip: "Runtime attribution",
    settingsAndMore: "Settings and more",
    visitGithub: "Runtime attribution",
    reportIssue: "Report a issue",
    contactUs: "Contact us",
    about: "About EvidaraOS",
    logout: "Log out",
  },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to EvidaraOS",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate EvidaraOS faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how EvidaraOS looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "EvidaraOS can learn from your conversations in the background. These memories help personalize workspace responses.",
    ...
    notification: {
      title: "Notification",
      description:
        "EvidaraOS only sends a completion notification when the window is not active. This is useful for long-running evidence workflows.",
