...
export const zhCN: Translations = {
  ...
  welcome: {
    greeting: "你好，欢迎回来！",
    description:
      "欢迎使用 EvidaraOS，一个面向生命科学团队的证据工作区。通过内置和自定义的 Skills，\nEvidaraOS 可以帮助你检索、分析、提取并追踪证据工作流。",

    createYourOwnSkill: "创建你自己的 Agent SKill",
    createYourOwnSkillDescription:
      "创建你的 Agent Skill 来扩展 EvidaraOS。通过自定义技能，EvidaraOS\n可以支持特定的证据审查、建模、监管、支付方或发现工作流。",
  },
  ...
  agents: {
    ...
    saving: "正在保存智能体...",
    saveRequested:
      "已提交保存请求，EvidaraOS 正在根据当前对话生成并保存初版智能体。",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "智能体已创建，但 EvidaraOS 暂时还无法读取到它。请稍后刷新当前页面。",
    more: "更多操作",
    agentCreated: "智能体已创建！",
    startChatting: "开始对话",
  ...
  // Workspace
  workspace: {
    officialWebsite: "访问 EvidaraOS 网站",
    githubTooltip: "查看运行时归属信息",
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在 EvidaraOS 中使用",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription: "使用键盘快捷键更快地操作 EvidaraOS。",
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 EvidaraOS 的界面和行为。",
    sections: {
      account: "账号",
      appearance: "外观",
      memory: "记忆",
    ...
    memory: {
      title: "记忆",
      description:
        "EvidaraOS 会在后台从你的对话中学习。这些记忆能帮助 EvidaraOS 更好地理解你的工作流，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
    ...
    skills: {
      ...
      emptyTitle: "还没有技能",
      emptyDescription:
        "将你的 Agent Skill 文件夹放在 EvidaraOS 工作区的 `/skills/custom` 文件夹中。",
      emptyButton: "创建你的第一个技能",
    },
    notification: {
      title: "通知",
      description:
        "EvidaraOS 只会在窗口不活跃时发送完成通知，特别适合长时间任务：你可以先去做别的事，完成后会收到提醒。",
